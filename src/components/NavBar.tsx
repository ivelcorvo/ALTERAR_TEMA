...
const NavBar = () => {
  ...
  const {tema,toggleTema} = useTemaContext();
    ...
    <>
      ...
      <header className={`flex flex-row justify-between mb-10 shadow-md ${(tema)?"bg-gray-200":"bg-gray-800"}`}>
        ...
        <div className="flex items-center">
          <button className="bg-gray-400 text-white me-3 px-4 py-2 rounded-xl hover:scale-110 hover:cursor-pointer" onClick={()=>toggleTema()}>
